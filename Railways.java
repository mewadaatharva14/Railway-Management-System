    ...
    public static void main(String[] args)throws Exception {
        ...
        int choice;
         String driverName = "com.mysql.cj.jdbc.Driver";
            ...
            String dburl = "jdbc:mysql://localhost:3306/atharva";
            String dbuser = "root";
            String dbpass = "";
        ...
        System.out.println("3. To Sign Out You Account");// make package of loc 15 to 20 (after not yet)
        System.out.println("4. For Inserting Train Info");
        System.out.println("5. To Delete Train Record");
        System.out.println("6. To Update Train Record");
...
class Series
{
    void add1(Connection con) throws Exception
    {
        ...
        {
             System.out.println("\u001B[31mPlease Enter valid age\u001B[37m");
        }
        sc.nextLine();
...
class Train1
{
    ...
    void insertion(Connection con) throws Exception
    {
        String sql = "insert into trains values(?,?,?,?,?,?,?,?,?,?,?,?,?)" ;
        PreparedStatement cst = con.prepareStatement(sql);
        System.out.println("Enter PNR of Train");
        try
        {
        ...
        {
            System.out.println("\u001B[31mPlease Enter valid PNR\u001B[37m");
        }
        ...
        cst.setString(3,departure.toUpperCase());
        System.out.println("Enter Destination");
        System.out.println(" Ahmedabad (AHM)    Mumbai (BOM)");
        System.out.println(" Delhi (DEL)  Kolkata (KOL)");
        String destination = sc.next();
        cst.setString(4,destination.toUpperCase());
    ...
    void checking(Connection con,String email,String password) throws Exception
    {
     ...
     cst.execute();
        ...
        while(rs1.next())
        {
            ...
            {
                System.out.println("\u001B[31mPlease Enter valid username and password\u001B[37m");
            }
    }
